...
csv_wood = (glob("../gym/v5/modelOut/wood/v1/*per_sample_val.csv")) + (glob("../modelOut/wood/v2/*per_sample_val.csv")) + (glob("../modelOut/wood/v3/*per_sample_val.csv"))
csv_water = (glob("../gym/v5/modelOut/water/v1/*per_sample_val.csv")) + (glob("../modelOut/water/v2/*per_sample_val.csv")) + (glob("../modelOut/water/v3/*per_sample_val.csv"))
csv_veg = (glob("../gym/v5/modelOut/veg/v1/*per_sample_val.csv")) + (glob("../modelOut/veg/v2/*per_sample_val.csv")) + (glob("../modelOut/veg/v3/*per_sample_val.csv"))
csv_all = (glob("../gym/v5/modelOut/all/v1/*per_sample_val.csv")) + (glob("../modelOut/all/v2/*per_sample_val.csv")) + (glob("../modelOut/all/v3/*per_sample_val.csv"))
