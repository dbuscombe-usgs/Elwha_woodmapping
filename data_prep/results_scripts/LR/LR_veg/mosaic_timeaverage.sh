...
rm Elwha_LR_veg_time_mean_prob.tif
...
rm Elwha_LR_veg_time_bin0.9_regrid.tif
gdalwarp -cutline LRgrid_epsg6339.geojson -crop_to_cutline -dstalpha -co "COMPRESS=LZW" -tr .125 .125 -t_srs epsg:6339 Elwha_LR_veg_time_bin0.9.tif Elwha_LR_veg_time_bin0.9_regrid.tif
